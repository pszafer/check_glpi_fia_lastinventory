...
#################################################################
#
# help : ./check_glpi_fia_lastinventory -h
...
sub print_usage {
	print "Usage: $name [-v] -H <host_target> -G <glpi_api_httpserver> -A <authorization user_token> -T <app-token> -w <warn_level> -c <crit_level> -U <units_level> [-t <timeout>]\n";
}
...
sub help {
	...
	To set S, Hetc. set Unit option to S, H, D, W or M.
	Default M.
	Warning have to be smaller than critical
	Critical - example 3M - 3 months, 3H - 3hours
